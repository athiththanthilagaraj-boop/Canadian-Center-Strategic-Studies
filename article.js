...
(function () {
  ...
  function renderArticle() {
    ...
    const heroHtml = pub.heroImage
      ? `<div class="article-hero">
          <img src="${pub.heroImage}" alt="${escapeHtml(pub.title)}">
          ${pub.imageCredit ? `<div class="article-hero-credit">${escapeHtml(pub.imageCredit)}</div>` : ""}
        </div>`
      : "";
